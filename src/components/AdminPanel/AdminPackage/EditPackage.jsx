      ...
      <div className="container mx-auto p-4 md:p-6 max-w-6xl">
        ...
        <div
          className={`bg-white rounded-xl shadow-md p-6 mb-8 ${
            activeSection !== "basic" && "hidden md:block"
          }`}
        >
        ...
        <div
          className={`bg-white rounded-xl shadow-md p-6 mb-8 ${
            activeSection !== "photos" && "hidden md:block"
          }`}
        >
          <h2 className="text-xl font-semibold mb-6 text-gray-800 border-b pb-2">
            Main Photos
        ...
        <div
          className={`bg-white rounded-xl shadow-md p-6 mb-8 ${
            activeSection !== "included" && "hidden md:block"
          }`}
        >
          <h2 className="text-xl font-semibold mb-6 text-gray-800 border-b pb-2">
            What's Included
        ...
        <div
          className={`bg-white rounded-xl shadow-md p-6 mb-8 ${
            activeSection !== "pricing" && "hidden md:block"
          }`}
        >
          <h2 className="text-xl font-semibold mb-6 text-gray-800 border-b pb-2">
            Package Pricing
        ...
        <div
          className={`bg-white rounded-xl shadow-md p-6 mb-8 ${
            activeSection !== "days" && "hidden md:block"
          }`}
        >
          <h2 className="text-xl font-semibold mb-6 text-gray-800 border-b pb-2">
            Day Description
        ...
        <div
          className={`bg-white rounded-xl shadow-md p-6 mb-8 ${
            activeSection !== "details" && "hidden md:block"
          }`}
        >
          <h2 className="text-xl font-semibold mb-6 text-gray-800 border-b pb-2">
        ...
        <div
          className={`bg-white rounded-xl shadow-md p-6 mb-8 ${
            activeSection !== "hotels" && "hidden md:block"
          }`}
        >
          <h2 className="text-xl font-semibold mb-6 text-gray-800 border-b pb-2">
            Hotels
